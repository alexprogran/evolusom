    ...
    <header className="header"> 
      <div className="header-container">
        <nav className={`nav ${menuAberto ? 'nav-aberto' : ''}`}>
          <a onClick={() => scrollParaSecao('sobre')} className="nav-link">Sobre nós</a>
          <a onClick={() => scrollParaSecao('servicos')} className="nav-link">Serviços</a>
          <a onClick={() => scrollParaSecao('videos')} className="nav-link">Vídeos</a>
          <a onClick={() => scrollParaSecao('produtos')} className="nav-link">Produtos</a>
          <a onClick={() => scrollParaSecao('contato')} className="nav-link">Contato</a>
          <a
